object WordInputForm: TWordInputForm
  ...
  object cmdWordUpdate: TADOCommand
    CommandText = 
      'UPDATE'#13#10'    Word'#13#10'SET '#13#10'    ImportanceLevel = :ImportanceLevel,'#13 +
      #10'    DifficultyLevel =  :DifficultyLevel,'#13#10'    UpdateTime = (sel' +
      'ect GETDATE())'#13#10'WHERE'#13#10'    Word = :Word'
    Connection = dmManager.conEnglish
    Parameters = <
      item
        Name = 'ImportanceLevel'
